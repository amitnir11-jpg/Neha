...
class AuthNotifier extends StateNotifier<AuthState> {
  ...
  Future<bool> login(
    ...
    return await _handleResult(result, dealerCode: dealerCode);
  }
  ...
  Future<bool> _handleResult(Map<String, dynamic> result,
    ...
    if (result['success'] == true) {
      ...
      final savedDealer =
          result['dealerCode']?.toString().trim().isNotEmpty == true
              ? result['dealerCode'].toString()
              : dealerCode.trim();
      if (savedDealer.isNotEmpty) {
        await _storage.write(key: 'daksh_last_dealer_code', value: savedDealer);
      }
      if (result['user'] != null) {
