...
router.post('/sync', auth.optionalAuth, sync.pushHandler);
router.post('/scan', auth.optionalAuth, sync.pushHandler);
router.post('/realtime-scan', auth.optionalAuth, sync.pushHandler);
